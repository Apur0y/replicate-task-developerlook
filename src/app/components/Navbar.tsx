    ...
    <>
      <nav
        ...
        className={`fixed left-0 right-0 z-50 transition-all duration-500 ${
          hasGlass && scrollY > 30
            ? "bg-white/50 backdrop-blur-xl border-b border-white/20 shadow-lg rounded-4xl mt-2 mx-2"
        ...
        <div className="mx-auto px-6 py-2">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              {/* CTA BUTTON */}
              <button
                className={`hidden lg:block relative overflow-hidden rounded-3xl hover:rounded transition-all group cursor-pointer ${
                  hasGlass && scrollY > 30
                    ? "bg-black text-white"
                    : "bg-white text-black"
                }`}
              >
                <span className="flex items-center justify-center gap-2 px-4 py-3 transition-transform duration-300 group-hover:-translate-y-full">
                  Get In Touch
      ...
      {/* MOBILE MENU */}
      <div
        className={`fixed inset-0 top-2 left-2 right-2 rounded-3xl z-[100] bg-black/70 backdrop-blur-md transition-all duration-500 ${
          mobileOpen
      ...
      >
        <div
          className={`absolute   h-full w-full   text-white p-6 transition-transform duration-500 ${
